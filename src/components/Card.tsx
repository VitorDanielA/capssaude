...
export default function Card(props:propsCard){
    return(
        <div className="w-[350px] h-[320px] border rounded-xl border-neutral-400 flex items-center justify-center flex-col text-center mx-5 my-5 hover:bg-cyan-800 hover:text-white cursor-pointer">
